...
\usepackage{cleveref,parskip,textcomp,fullpage,fancyhdr,graphicx}
...
\begin{enumerate}
	\item Styret velges av generalforsamlingen, og skal kun bestå av studenter ved Institutt for informatikk.
	...
	\item Valg av styremedlemmer på generalforsamling skjer ved \textit{Instant-runoff vote}\footnotemark.
		\footnotetext{Også kjent som \textit{IRV}, eller \textit{alternativ stemmegivning}.}
\end{enumerate}
